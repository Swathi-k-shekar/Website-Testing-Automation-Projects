//Availability of hotel rooms in next week (e.g. 27 July Check in and 28 July Check out) for a specific city. Ex: Mumbai
...
public class Avilablity {
	...
	public static void main(String[] args) throws NoSuchElementException, InterruptedException {
		//Setting up driver
		        ...
		        // Select check-in and check-out data)
		        WebElement checkInAction= driver.findElement(By.xpath("//*[@id=\"overlay-root\"]/div/section/main/div/div/div/div[2]/div[1]/div/button[20]/time"));
		        //checkInAction.click();
		        js.executeScript("arguments[0].click();", checkInAction);
		        WebElement checkOutAction= driver.findElement(By.xpath("//*[@id=\"overlay-root\"]/div/section/main/div/div/div/div[2]/div[1]/div/button[21]/time"));    
		        //checkOutAction.click();
		        js.executeScript("arguments[0].click();", checkOutAction);
